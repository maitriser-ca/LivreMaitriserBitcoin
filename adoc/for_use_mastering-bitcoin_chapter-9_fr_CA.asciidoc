...
(((&quot;vérification simplifiée des paiements ou Simplified-payment-verification (SPV)&quot;)))(((&quot;noeuds Bitcoin&quot;, &quot;noeuds SPV&quot;)))Les arbres Merkle sont largement utilisés par les nœuds SPV. Les nœuds SPV n'ont pas toutes les transactions et ne téléchargent pas les blocs complets, juste les en-têtes de bloc. Afin de vérifier qu'une transaction est incluse dans un bloc, sans avoir à télécharger toutes les transactions du bloc, ils utilisent un chemin d'authentification, ou chemin de Merkle.
