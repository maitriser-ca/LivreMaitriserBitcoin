...
* Si vous développez un logiciel bitcoin et que vous devez vous fier à un nœud Bitcoin pour un accès programmable (API) au réseau et à la chaîne de blocs.
...
Cela montre un nœud avec une hauteur de chaîne de blocs de 0 blocs et 83999 en-têtes. Le nœud récupère actuellement les en-têtes de bloc de la meilleure chaîne et continue ensuite à télécharger les blocs complets.
...
Dans &lt;<cup_of_coffee>&gt;, ((("cas d'utilisation", "acheter du café", id="alicethree")))Alice a acheté une tasse de café au Bob's Cafe. Sa transaction a été enregistrée sur la chaîne de blocs avec l'identifiant de transaction (+txid+) +0627052b6f28912f2703066a912ea577f2ce4da4caa5a5fbd8a57286c345c2f2+. Utilisons l'API pour récupérer et examiner cette transaction en transmettant l'identifiant de transaction en tant que paramètre :
...
Le bloc contient 419 transactions et la 64ème transaction répertoriée (+0627052b...+) est le paiement du café d'Alice. L'entrée + hauteur + nous indique qu'il s'agit du 277316e bloc de la chaîne de blocs.
...
https://bitcore.io/[Bitcore]:: nœud complet, API et bibliothèque par Bitpay
