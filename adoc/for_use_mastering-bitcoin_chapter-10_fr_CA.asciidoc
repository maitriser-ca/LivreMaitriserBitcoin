...
De l'autre côté du réseau, le mineur nœud Y construit une blockchain basée sur sa propre perspective de la séquence des événements. Le mineur nœud Y a extrait (créé) le &quot;triangle inversé&quot; et considère initialement cette chaîne comme la chaîne principale (la chaîne &quot;gagnante&quot;). Lorsqu'il a ensuite reçu le bloc &quot;triangle&quot; extrait par le Nœud X, il l'a connecté au parent du bloc &quot;étoile&quot; en tant que chaîne secondaire.
