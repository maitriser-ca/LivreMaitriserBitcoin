...
((("propositions d'améliorations de bitcoin", "Bloc v2, hauteur dans Coinbase (BIP-34)"))) La première implémentation, dans BIP-34, utilisait le champ de version de bloc pour permettre aux mineurs de signaler qu'ils étaient prêts pour un changement de règle de consensus spécifique. Avant le BIP-34, la version du bloc était définie par la valeur "1" par _convention_ non appliquée par _consensus_.
...
((("propositions d'améliorations de bitcoin", "Bits de version avec délai d'expiration et délai (BIP-9)")))((("propositions d'améliorations de bitcoin", "CHECKLOCKTIMEVERIFY (BIP-65)")))((("propositions d'améliorations de Bitcoin", "Strict DER signatures (BIP-66)"))) Le mécanisme utilisé par BIP-34, BIP-66 et BIP-65 a réussi à activer trois embranchements convergents. Cependant, il a été remplacé car il présentait plusieurs limitations :
