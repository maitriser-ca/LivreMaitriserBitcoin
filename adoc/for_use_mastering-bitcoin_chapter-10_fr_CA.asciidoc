...
Dans &lt;<fork2>&gt;, on voit deux mineurs (Noeud X et Noeud Y) qui minent deux blocs différents presque simultanément. Ces deux blocs sont des enfants du bloc étoile et étendent la chaîne en s'appuyant sur le bloc étoile. Pour nous aider à le suivre, l'un est visualisé comme un bloc triangulaire provenant du nœud X, et l'autre est représenté comme un bloc triangulaire inversé provenant du nœud Y.
...
[[blockchainwithforks]]
.Une blockchain avec des fourches
