...
[table\_title](#tx_script_ops_table_pushdata) affiche les opérateurs
...
<th style="text-align: left;">Valeur (hex)</th>
...
[table\_title](#tx_script_ops_table_control) affiche les opérateurs de
...
<td style="text-align: left;"><p>Interrompt la transaction non valide à
moins qu'elle ne se trouve dans une clause OP_IF non exécutée</p></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><p>Interrompt la transaction
invalide</p></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><p>Vérifie le haut de la pile, arrête et
invalide la transaction si elle n'est pas VRAIE</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_RETURN</p></td>
<td style="text-align: left;"><p>0x6a</p></td>
<td style="text-align: left;"><p>Arrête et invalide la
transaction</p></td>
</tr>
</tbody>
</table>
...
[table\_title](#tx_script_ops_table_timelock) affiche les opérateurs
utilisés pour les verrous temporels.

<table>
<caption>Opérations de verrou temporel</caption>
<colgroup>
<col style="width: 33%" />
<col style="width: 33%" />
<col style="width: 33%" />
...
[table\_title](#tx_script_ops_table_stack) montre les opérateurs
...
<td style="text-align: left;"><p>Extrait l'élément supérieur de la pile
et le pousse vers une autre pile</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_FROMALTSTACK</p></td>
<td style="text-align: left;"><p>0x6c</p></td>
<td style="text-align: left;"><p>Extrait l'élément supérieur de la pile
alternative et le pousse pour empiler</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p>OP_2DROP</p></td>
<td style="text-align: left;"><p>0x6d</p></td>
<td style="text-align: left;"><p>Extrait top deux éléments de la
pile</p></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><p>Alterne les trois premiers éléments de
la pile</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_SWAP</p></td>
<td style="text-align: left;"><p>0x7c</p></td>
<td style="text-align: left;"><p>Échange les deux premiers éléments de
la pile</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p>OP_TUCK</p></td>
<td style="text-align: left;"><p>0x7d</p></td>
<td style="text-align: left;"><p>Copie l'élément supérieur et l’insère
entre l'élément supérieur et le deuxième élément</p></td>
</tr>
</tbody>
</table>
...
[table\_title](#tx_script_ops_table_splice) affiche les opérateurs de
chaîne.

<table>
<caption>Opérations d'épissure de chaînes de caractère</caption>
<colgroup>
<col style="width: 33%" />
<col style="width: 33%" />
<col style="width: 33%" />
...
[table\_title](#tx_script_ops_table_binmath) affiche les opérateurs
...
<td style="text-align: left;"><p>Pousse TRUE (1) si les deux premiers
éléments sont exactement égaux, pousse FALSE (0) sinon</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_EQUALVERIFY</p></td>
<td style="text-align: left;"><p>0x88</p></td>
<td style="text-align: left;"><p>Identique à OP_EQUAL, mais exécute
...
<td style="text-align: left;"><p>Interruption - Transaction non valide à
moins qu'elle ne se trouve dans une clause OP_IF non exécutée</p></td>
</tr>
<tr class="even">
...
[table\_title](#tx_script_ops_table_numbers) affiche les opérateurs
...
<td style="text-align: left;"><p>Ajouter 1 à l'élément au dessus de la
pile</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_1SUB</p></td>
<td style="text-align: left;"><p>0x8c</p></td>
<td style="text-align: left;"><p>Soustraire 1 de l'élément au dessus de
la pile</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p><em>OP_2MUL</em></p></td>
<td style="text-align: left;"><p>0x8d</p></td>
<td style="text-align: left;"><p>Désactivé (multiplier l'élément au
dessus de la pile par 2)</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p><em>OP_2DIV</em></p></td>
<td style="text-align: left;"><p>0x8e</p></td>
<td style="text-align: left;"><p>Désactivé (diviser l'élément au dessus
de la pile par 2)</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p>OP_NEGATE</p></td>
<td style="text-align: left;"><p>0x8f</p></td>
<td style="text-align: left;"><p>Inverse le signe de l'élément au dessus
de la pile</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_ABS</p></td>
<td style="text-align: left;"><p>0x90</p></td>
<td style="text-align: left;"><p>Change le signe de l'élément au dessus
de la pile en positif</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p>OP_NOT</p></td>
<td style="text-align: left;"><p>0x91</p></td>
<td style="text-align: left;"><p>Retourne l’élément du dessus si
l'élément est 0 ou 1 booléen, sinon retourne 0</p></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><p>Sort les deux éléments au dessus de la
pile, les additionnes et pousse le résultat</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>OP_SUB</p></td>
<td style="text-align: left;"><p>0x94</p></td>
<td style="text-align: left;"><p>Sort les deux éléments au dessus de la
pile, soustrait le premier du second et pousse le résultat</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p><em>OP_MUL</em></p></td>
<td style="text-align: left;"><p>0x95</p></td>
<td style="text-align: left;"><p>Désactivé (multiplie les deux premiers
éléments)</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p><em>OP_DIV</em></p></td>
<td style="text-align: left;"><p>0x96</p></td>
<td style="text-align: left;"><p>Désactivé (divise le deuxième élément
...
<td style="text-align: left;"><p>Désactivé (décale le deuxième élément
...
<td style="text-align: left;"><p>Renvoie TRUE si le deuxième élément est
...
<td style="text-align: left;"><p>Renvoie TRUE si le troisième élément
...
[table\_title](#tx_script_ops_table_crypto) affiche les opérateurs de
...
<td style="text-align: left;"><p>Renvoye le hachage RIPEMD160 de
l'élément supérieur</p></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><p>Marque le début des données vérifiées
par signature</p></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><p>OP_CHECKSIG</p></td>
<td style="text-align: left;"><p>0xac</p></td>
<td style="text-align: left;"><p>Sort une clé publique et une signature
et valide la signature pour les données hachées de la transaction,
renvoie TRUE si cela correspond</p></td>
</tr>
<tr class="even">
...
<td style="text-align: left;"><p>Exécute CHECKSIG pour chaque paire de
...
[table\_title](#tx_script_ops_table_nop) affiche les symboles non
opérateur.

<table>
<caption>Non opérateurs</caption>
<colgroup>
<col style="width: 33%" />
<col style="width: 33%" />
<col style="width: 33%" />
...
[table\_title](#tx_script_ops_table_internal) affiche les codes
